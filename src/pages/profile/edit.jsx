    ...
    <div className='flex justify-center items-center p-5 lg:p-10 xl:p-20 border-4 border-sky-500 rounded-2xl my-20 mx-5 lg:mx-20 xl:mx-40 2xl:mx-60 bg-slate-100 shadow-2xl'>
        <div className='grid lg:grid-cols-2 gap-5'>
            <div className='flex flex-col'>
                <img className='border-2 border-sky-500 mb-5' src="../missing-found.jpg" alt="foto [username]" />
                <div className='flex flex-col md:flex-row gap-5'>
                    <Button className='w-[150px] bg-sky-500'>Edit</Button>
            ...
            <form action="" className='flex flex-col gap-5'>
                ...
                <Input type="submit" value="Update Profile" className="bg-sky-500 text-white" />
            </form>
        </div>
    </div>
  )
